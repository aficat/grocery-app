            ...
            return (
              <div key={item.id} className="flex items-center gap-3 border-b pb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" onClick={() => dispatch({ type: "REMOVE_FROM_CART", id: item.id })}>
                    Remove
                  </Button>
                </div>
              </div>
        ...
        <div className="fixed left-1/2 -translate-x-1/2 bottom-20 w-[min(100%,420px)] px-4">
          <Sheet>
            <SheetTrigger asChild>
              <Button className="w-full h-12">Checkout <span className="ml-auto opacity-80 pl-2">${totals.subtotal.toFixed(2)}</span></Button>
            </SheetTrigger>
            <SheetContent side="bottom" className="rounded-t-3xl pb-8">
              ...
              <div className="mt-4 space-y-4">
                ...
                <Button className="w-full h-12" onClick={() => dispatch({ type: "CLEAR_CART" })}>
                  Place order
                </Button>
              </div>
            </SheetContent>
